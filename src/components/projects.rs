...
pub fn projects() -> Html {
    ...
    html! {
        <section id="projects" class="py-20 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-200 scroll-mt-16">
